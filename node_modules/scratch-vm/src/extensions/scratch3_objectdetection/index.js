...
'use strict';
 ...
 var Video = require("scratch-vm/src/io/video.js");
 var StageLayering = require("scratch-vm/src/engine/stage-layering.js");
...
class objectDetection{
    constructor(runtime){
        ...
        var _this = this;
        console.log("testing cocossd"+ cocoSsd);
    ...
    netModel = new Promise(function (resolve) {
      ...
      console.log("testing 2" + cocoSsd);
      cocoSsd.load({
        base: 'lite_mobilenet_v2',
        modelUrl: 'static/models/objectDetection/model.json'
      }).catch(function (err) {
        console.log('mylogger'+err) ;
        
      })
      .then(function (net) {
        
        console.log("testing mm"+net);
        netModel2 = net;
        console.log("testing mm"+netModel2);
