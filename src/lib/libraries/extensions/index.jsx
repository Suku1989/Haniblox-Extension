...
import posenetImageIconURL from './posenet/posenet-small.svg';
...
export default [
    ...
    },
    {
        ...
        insetIconURL: posenetImageIconURL,
	description: (
            <FormattedMessage
...
//    },
   {
	...
	description: (
            <FormattedMessage
                defaultMessage="Arduino chrome only"
    ...
    },
    {
        ...
        description: (
        	<FormattedMessage
            	defaultMessage="ESP-8266"
            	description="ESP-8266 extension"
